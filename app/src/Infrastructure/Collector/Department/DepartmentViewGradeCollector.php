...
final class DepartmentViewGradeCollector extends AbstractCollector
{
    ...
    public function collect(Request $request): DepartmentViewGradeInput
    {
        $requestData = $request->toArray();

        return new DepartmentViewGradeInput(
